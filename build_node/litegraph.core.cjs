...
// var getGlobalObject = getGlobalObject;
// var setGlobalVariable = setGlobalVariable;
// var getGlobalVariable = getGlobalVariable;
...
const LiteGraph = getGlobalVariable("LiteGraph");
/**
 * WIP
